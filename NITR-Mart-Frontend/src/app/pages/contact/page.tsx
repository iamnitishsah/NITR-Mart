...
import { RiGithubLine, RiInstagramLine, RiLinkedinFill, RiTwitterXFill, RiWhatsappFill } from "react-icons/ri";
...
const ContactPage = () => {
    ...
    const sendViaWhatsApp = (e: React.FormEvent) => {
        ...
        const whatsappMessage = `*New Contact Request*%0A%0A` +
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white">
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-start">
                                        ...
                                        <div className="ml-4">
                                            ...
                                            <p className="text-gray-500 text-sm mt-2">Fastest response time</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start">
                                        ...
                                        <div className="ml-4">
                                            ...
                                            <p className="text-gray-400 mt-1">nitrmart2027@gmail.com</p>
                                            <p className="text-gray-500 text-sm mt-2">Typically replies within 24 hours</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start">
                                        ...
                                        <div className="ml-4">
                                            ...
                                            <p className="text-gray-500 text-sm mt-2">Student Activity Center</p>
                                        </div>
                                    </div>
            ...
            {/* FAQ Section */}
            {/* FAQ Section */}
            <section className="py-16 px-4 bg-gray-900/20 relative z-10">
                <div className="max-w-4xl mx-auto">
                        ...
                        {[
                            {
                                ...
                                answer: "Simply click on the 'Sign Up' button and use your @nitrkl.ac.in email address to register."
                            },
                            {
                                question: "Is NITR Mart only for NIT Rourkela students?",
                                answer: "Yes, our platform is exclusively for current students, alumni, and faculty of NIT Rourkela."
                            },
                            {
                                question: "How are payments handled?",
                                answer: "We recommend cash transactions in person for security. Meet in safe campus locations for exchanges."
                            },
                            {
                                question: "What items are prohibited?",
                                answer: "We don't allow illegal items, alcohol, drugs, weapons, or any items violating campus policies."
                            }
                        ].map((faq, index) => (
                            <div key={index} className="bg-gray-900/40 backdrop-blur-xl border border-gray-700/50 rounded-xl p-6 hover:border-cyan-500/50 transition-all duration-300">
