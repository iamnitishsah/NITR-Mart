  ...
  const mockProducts = [
    {
      ...
      negotiable: true,
      image:
        "https://a2zbookhub.in/wp-content/uploads/2024/03/Object-Oriented-Programming-with-C-By-Thareja.jpg",
      category: "books",
      is_sold: false,
    ...
    },
    {
      ...
      description:
        "Gently used bicycle in great condition, perfect for campus commuting",
      negotiable: true,
      image:
        "https://rforrabbit.com/cdn/shop/files/RforRabbitCruizeBicycleforKids16inchOliveGreen_1.jpg?v=1721307165",
      category: "vehicles",
      is_sold: false,
    ...
    },
    {
      ...
      title: "Cabinate",
      description:
        "Stylish and detachable cabinet for sale, perfect for hostel or office use",
      negotiable: true,
      image:
        "https://www.nilkamalfurniture.com/cdn/shop/products/FMDR1CWBNBSTWBN_01.jpg?v=1636442511&width=1080",
      category: "furniture",
      is_sold: false,
      created_at: "2024-01-01",
      updated_at: "2024-01-01",
    },
    {
      ...
      title: "Games",
      description:
        "Popular games for sale, great condition, perfect for gaming enthusiasts",
      negotiable: true,
      image:
        "https://images.unsplash.com/photo-1611195974226-a6a9be9dd763?fm=jpg&q=60&w=3000&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDE3fHx8ZW58MHx8fHx8",
      category: "gaming",
      is_sold: false,
      created_at: "2024-01-01",
      updated_at: "2024-01-01",
    },
    {
      ...
      negotiable: true,
      image:
        "https://www.rasoishop.com/cdn/shop/files/8901309227735-9.jpg?v=1701447072",
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white overflow-hidden relative">
      ...
      >
        <div className="pt-5 max-w-7xl mx-auto text-center">
          ...
          <h1
            className={`text-5xl md:text-7xl font-black mb-6 bg-gradient-to-r from-white via-cyan-200 to-emerald-300 bg-clip-text text-transparent transition-all duration-1000 ${
              isVisible.hero
          ...
          <p
            className={`text-xl md:text-2xl text-gray-300 mb-4 max-w-3xl mx-auto transition-all duration-1000 delay-300 ${
              isVisible.hero
                ? "translate-y-0 opacity-100"
                : "translate-y-10 opacity-0"
            }`}
          ...
          >
            The sustainable marketplace built by NITians, for NITians. Buy,
            sell, and discover amazing deals while building lasting connections
            in our trusted community.
          </p>
      ...
      <section className=" px-4 relative z-10" data-section id="features">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2
              className={`text-4xl md:text-5xl font-black mb-6 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent transition-all duration-1000 ${
                isVisible.features
                  ? "translate-y-0 opacity-100"
                  : "translate-y-10 opacity-0"
              }`}
            ...
            >
              ...
              that believes in sustainable living and student connections.
            </p>
          </div>
            ...
            {features.map((feature, index) => (
              ...
              >
                <div className="bg-gray-900/40 backdrop-blur-xl border border-gray-700/50 rounded-2xl p-8 hover:border-gray-600/50 transition-all duration-300 hover:transform hover:scale-105 hover:shadow-2xl hover:shadow-cyan-500/20">
                  <div
                    className={`w-16 h-16 bg-gradient-to-r ${feature.gradient} rounded-2xl flex items-center justify-center text-white mb-6 group-hover:scale-110 transition-transform duration-300 group-hover:rotate-12`}
                  >
                    {feature.icon}
                  </div>
                  <h3
                    className="text-xl font-bold mb-4 text-white group-hover:text-cyan-300 transition-colors"
      ...
      <section
        className="py-20 px-4 bg-gray-900/20 relative z-10"
        data-section
        id="how-it-works"
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p
              className={`text-xl text-gray-400 transition-all duration-1000 delay-300 ${
                isVisible["how-it-works"]
                  ? "translate-y-0 opacity-100"
                  : "translate-y-10 opacity-0"
              }`}
            ...
            {[
              {
                ...
                description:
                  "Create your account using your @nitrkl.ac.in email address. We verify all users to ensure a safe community.",
                icon: <Shield className="w-8 h-8" />,
              },
              {
                step: "02",
                ...
                description:
                  "Explore categories, find what you need, or list items you want to sell. Chat directly with other students.",
              ...
              },
              {
                ...
                title: "Trade & Thrive",
                description:
                  "Complete secure transactions, meet in safe campus locations, and build lasting connections with fellow NITians.",
              ...
              >
                ...
                <h3
                  className="text-2xl font-bold mb-4 text-white group-hover:text-cyan-300 transition-colors"
            ...
            {categories.map((category, index) => (
              ...
              >
                <div className="bg-gray-900/40 backdrop-blur-xl border hover:border-cyan-500/50 border-gray-700/50 rounded-2xl p-6 text-center hover:shadow-2xl hover:shadow-purple-500/20 transition-all duration-300 hover:scale-105">
                  <div
                    className={`w-16 h-16 bg-gradient-to-r ${category.gradient} rounded-xl flex items-center justify-center mx-auto mb-4 group-hover:rotate-12 transition-transform duration-300`}
                  >
                    {category.icon}
                  </div>
                  <h3
      ...
      <section className="py-10 relative z-10" data-section id="cta">
        <div className="max-w-4xl mx-auto text-center">
          <div
            className={`bg-gradient-to-r from-cyan-500/10 to-emerald-500/10 rounded-3xl border border-cyan-500/20 p-12 md:p-16 transition-all duration-1000 ${
              isVisible.cta
          ...
          >
            <h2
              className="text-4xl md:text-5xl font-black mb-6 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent"
              style={{
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Join thousands of NITR students who are already buying, selling,
              and connecting on our platform. Start your sustainable trading
              journey today!
            </p>
